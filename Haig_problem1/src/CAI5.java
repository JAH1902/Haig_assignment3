...
public class CAI5 {
	...
	public static void askQuestion() {
		...
		if (getType() == 1)
			System.out.printf("Solve this addition problem: %d + %d \n", getRand1(), getRand2());
		
		else if (getType() == 2) 
			System.out.printf("Solve this multiplication problem: %d * %d \n", getRand1(), getRand2());
		
		else if (getType() == 3)
			System.out.printf("Solve this subtraction problem: %d - %d \n", getRand1(), getRand2());
		
		else if (getType() == 4)
			System.out.printf("Solve this division problem: %d / %d \n", getRand1(), getRand2());
	...
	public static void readProblemType() {
		...
		System.out.printf("Please enter argument type: \n");
	...
	public static void setType(int r) {
